            ...
            <div className="space-y-4">
                    ...
                    <section className="bg-[#2c3e50]/30 rounded-lg p-4">
                        ...
                        <div className="flex gap-2 flex-wrap">
                            <button
                                ...
                                className="bg-gradient-to-br from-[#e67e22] to-[#d35400] text-white px-4 py-2 rounded-lg font-medium uppercase tracking-wide text-sm hover:from-[#f39c12] hover:to-[#e67e22] transition-all hover:-translate-y-0.5 hover:shadow-lg"
                            >
                                Manual Save
                            </button>
                            <button
                ...
                <section className="bg-[#2c3e50]/30 rounded-lg p-4">
                    ...
                    <button
                        ...
                        className="bg-gradient-to-br from-[#c0392b] to-[#e74c3c] text-white px-4 py-2 rounded-lg font-medium uppercase tracking-wide text-sm hover:from-[#e74c3c] hover:to-[#c0392b] transition-all hover:-translate-y-0.5 hover:shadow-lg"
                    >
                        Clear Save Data
                    </button>
                </section>
